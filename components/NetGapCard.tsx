  ...
  return (
    <div
      ...
      className={`rounded-2xl border p-5 sm:p-6 transition shadow-sm ${
        isSafe
          ? 'bg-gradient-to-br from-emerald-900/90 via-slate-900 to-emerald-950 text-white border-emerald-500/40'
          : 'bg-gradient-to-br from-amber-900/90 via-slate-900 to-rose-950 text-white border-amber-500/40'
      }`}
    >
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        {onOpenAiAdvice && (
          <button
            ...
            className="w-full md:w-auto bg-white/10 hover:bg-white/20 text-white text-xs font-bold px-4 py-2.5 rounded-xl border border-white/20 transition flex items-center justify-center gap-2 whitespace-nowrap"
          >
      ...
      <div className="mt-5">
        <div className="flex justify-between items-center text-xs mb-1.5">
          ...
          <span className="font-bold text-emerald-300">{coveragePercent}%</span>
        </div>
