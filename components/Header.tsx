        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center justify-between w-full md:w-auto">
            <div className="flex items-center gap-3">
              <div className="bg-emerald-500/20 text-emerald-400 p-2.5 rounded-xl border border-emerald-500/30 flex items-center justify-center">
                <Wallet className="w-6 h-6" />
              </div>
              <div>
                <h1 className="text-xl font-bold tracking-tight text-white flex items-center gap-2">
                  محفظتي
                  <span className="text-xs font-normal bg-emerald-500/20 text-emerald-300 px-2 py-0.5 rounded-full border border-emerald-500/30 flex items-center gap-1">
                    <CloudCheck className="w-3.5 h-3.5 text-emerald-400" />
                    <span>مزامنة Firebase</span>
                  </span>
                </h1>
                <p className="text-xs text-slate-400">
                  المحاسب المالي الذكي للمندوب • حفظ سحابي مشفر
                </p>
              </div>
            </div>

            {/* Wallet quick balance on mobile */}
            <div className="md:hidden text-left bg-slate-800/90 px-3 py-1.5 rounded-lg border border-slate-700">
              <span className="text-[10px] text-slate-400 block">رصيد المحفظة</span>
              <span className={`text-sm font-bold ${walletBalance >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
